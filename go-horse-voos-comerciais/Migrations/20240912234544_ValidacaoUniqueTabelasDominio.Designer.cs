...
namespace go_horse_voos_comerciais.Migrations
{
    ...
    [Migration("20240912234544_ValidacaoUniqueTabelasDominio")]
    partial class ValidacaoUniqueTabelasDominio
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("go_horse_voos_comerciais.Domain.Cliente.Clientes", b =>
                {
                    ...
                    b.HasIndex("Cpf", "Nome", "Email", "TelefoneCelular", "TelefoneFixo")
                        .IsUnique();
